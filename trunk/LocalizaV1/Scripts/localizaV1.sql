...
/****** Object:  Database [Localiza]    Script Date: 03/17/2015 18:57:30 ******/
CREATE DATABASE [Localiza] ON  PRIMARY 
( NAME = N'Localiza', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\DATA\Localiza.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Localiza_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\DATA\Localiza_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [Localiza] SET COMPATIBILITY_LEVEL = 100
GO
...
ALTER DATABASE [Localiza] SET AUTO_CREATE_STATISTICS ON 
GO
...
ALTER DATABASE [Localiza] SET RECOVERY FULL 
GO
